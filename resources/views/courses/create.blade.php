...
@section('content')
    <div class="container mx-auto px-4 py-8">
        ...
        <div class="mb-10 text-center">
            <h1 class="text-4xl font-bold text-gray-800 mb-3">Course Management</h1>
            <p class="text-gray-600 max-w-2xl mx-auto">Create and manage courses for your students. Upload video lectures or
                link to YouTube content.</p>
        </div>

        <!-- Success Message -->
        @if (session('success'))
            <div
                class="mb-6 bg-green-50 border-l-4 border-green-500 text-green-700 p-4 rounded-lg shadow-sm flex items-center animate-fadeIn">
        ...
        <div class="grid grid-cols-1 lg:grid-cols-3 gap-8 w-full max-w-7xl">
            ...
            <div class="lg:col-span-2">
                <div class="bg-white rounded-2xl shadow-lg p-6 transition-all duration-300 hover:shadow-xl">
                    ...
                    <form action="{{ route('courses.store') }}" method="POST" enctype="multipart/form-data"
                        ...
                        <div>
                            ...
                            <div class="relative">
                                <select name="student_id"
                                    class="w-full border border-gray-300 rounded-lg px-4 py-3 focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 outline-none transition appearance-none bg-white"
                                    required>
                        ...
                        <div>
                            <label class="block text-gray-700 font-medium mb-3">Lecture Type</label>
                            <div class="grid grid-cols-2 gap-4">
                                <label
                                    class="flex flex-col items-center justify-center p-4 border-2 border-gray-200 rounded-lg cursor-pointer transition-all duration-200 hover:border-indigo-300 radio-option">
                                    <input type="radio" name="lecture_type" value="file" checked class="sr-only peer">
                                    <div
                                        class="w-12 h-12 mb-2 rounded-full bg-indigo-100 flex items-center justify-center peer-checked:bg-indigo-500 peer-checked:text-white transition">
                                ...
                                <label
                                    ...
                                    <div
                                        class="w-12 h-12 mb-2 rounded-full bg-red-100 flex items-center justify-center peer-checked:bg-red-500 peer-checked:text-white transition">
                        ...
                        <div id="video-upload-section">
                            ...
                            <div
                                class="border-2 border-dashed border-gray-300 rounded-xl p-8 text-center hover:border-indigo-400 transition duration-300 bg-gray-50 hover:bg-indigo-50">
                                <input type="file" name="video" accept="video/*" id="video-upload" class="hidden" required>
                                <label for="video-upload" class="cursor-pointer">
                                    <div class="flex flex-col items-center justify-center">
                                        <div
                                            class="w-16 h-16 rounded-full bg-indigo-100 flex items-center justify-center mb-3">
                        ...
                        <div id="youtube-url-section" class="hidden">
                            ...
                            <div class="relative">
                                ...
                                <input type="text" name="youtube_url" id="youtube_url"
                                    class="w-full border border-gray-300 rounded-lg pl-10 pr-4 py-3 focus:ring-2 focus:ring-red-400 focus:border-red-400 outline-none transition shadow-sm"
            ...
            <div class="lg:col-span-1">
                <div class="bg-white rounded-2xl shadow-lg p-6 mb-6">
                    <h3 class="text-xl font-bold text-gray-800 mb-4">Course Statistics</h3>
                    <div class="space-y-4">
                        <div class="flex justify-between items-center pb-2 border-b border-gray-100">
                            <span class="text-gray-600">Total Courses</span>
                            <span class="font-bold">{{ $coursesCount ?? 0 }}</span>
                        </div>
                        <div class="flex justify-between items-center pb-2 border-b border-gray-100">
                            <span class="text-gray-600">Active Students</span>
                            <span class="font-bold">{{ $studentsCount ?? 0 }}</span>
                        </div>
                        <div class="flex justify-between items-center">
                            <span class="text-gray-600">Total Lectures</span>
                            <span class="font-bold">{{ $lecturesCount ?? 0 }}</span>
                        </div>
                    </div>
                </div>
                
                <div class="bg-indigo-50 rounded-2xl shadow-lg p-6">
                    <h3 class="text-xl font-bold text-indigo-800 mb-3">Tips for Creating Courses</h3>
                    <ul class="space-y-2 text-indigo-700">
                        <li class="flex items-start">
                            ...
                            <span>Keep video lectures under 15 minutes for better engagement</span>
                        </li>
                        <li class="flex items-start">
                            <svg class="h-5 w-5 text-indigo-500 mr-2 mt-0.5" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z"></path>
                            </svg>
                            <span>Use clear, descriptive titles for your courses</span>
                        </li>
                        <li class="flex items-start">
                            <svg class="h-5 w-5 text-indigo-500 mr-2 mt-0.5" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z"></path>
                            </svg>
                            <span>Assign courses to appropriate students based on their level</span>
                        </li>
                    </ul>
                </div>
            </div>
